...
Lets assume, the application listens on http://krb5.local:8080/ 
...
If something went wrong, for example, if you forget to login to kerberos with `kinit`, you'll get 401 response with the text *SPNEGO authentication is required* instead. 
